...
- (NSString *)machineModelName {
    ...
    dispatch_once(&one, ^{
        ...
        NSDictionary *dic = @{
            ...
            @"iPad6,3": @"iPadPro 9.7",
            @"iPad6,4": @"iPadPro 9.7",
            @"iPad6,7": @"iPadPro 12.9",
            @"iPad6,8": @"iPadPro 12.9",
            @"iPad6,11": @"iPad 5th",
            @"iPad6,12": @"iPad 5th",
            @"iPad7,1": @"iPadPro 12.9 2nd",
            @"iPad7,2": @"iPadPro 12.9 2nd",
            @"iPad7,3": @"iPadPro 10.5",
            @"iPad7,4": @"iPadPro 10.5",
            @"iPad7,5": @"iPad 6th",
            @"iPad7,6": @"iPad 6th",
            @"iPad7,11": @"iPad 7th",
            @"iPad7,12": @"iPad 7th",
            ...
            @"iPad8,3": @"iPadPro 11",
            @"iPad8,4": @"iPadPro 11",
            @"iPad8,5": @"iPadPro 12.9 3rd",
            @"iPad8,6": @"iPadPro 12.9 3rd",
            @"iPad8,7": @"iPadPro 12.9 3rd",
            @"iPad8,8": @"iPadPro 12.9 3rd",
            @"iPad11,1": @"iPad mini 5th",
            @"iPad11,2": @"iPad mini 5th",
            @"iPad11,3": @"iPadAir 3rd",
            @"iPad11,4": @"iPadAir 3rd",
            @"iPod1,1": @"iPod touch",
            ...
            @"AppleTV2,1": @"AppleTV 2nd",
            @"AppleTV3,1": @"AppleTV 3rd",
            @"AppleTV3,2": @"AppleTV 3rd",
            @"AppleTV5,3": @"AppleTV 4th",
            @"AppleTV6,2": @"AppleTV 4K",
            @"AirPods1,1": @"AirPods 1st",
            @"AirPods2,1": @"AirPods 2nd",
